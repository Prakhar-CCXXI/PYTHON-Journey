...
BLOG_TEXT = "Hi , this is the last assignment of the Tutedude course . An automated blog post using Selenium."
...
# Setup Chrome
service = Service('/home/prakhar/Selenium/selenium/chromedriver-linux64/chromedriver')
